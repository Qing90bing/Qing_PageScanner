...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  var en_default = {
    ...
    settings: {
      ...
      output: {
        ...
        tab_size: "TAB Indent Spaces",
        tab_size_description: "Spaces inserted by TAB, up to 3. Array and object output use the same indentation.",
        tab_size_options: {
          zero: "0 spaces",
          one: "1 space",
          two: "2 spaces",
  ...
  var zh_CN_default = {
    ...
    settings: {
      ...
      output: {
        ...
        tab_size: "TAB \u7F29\u8FDB\u7A7A\u683C\u6570",
        tab_size_description: "\u6309 TAB \u65F6\u63D2\u5165\u7684\u7A7A\u683C\u6570\uFF0C\u6700\u591A 3 \u4E2A\uFF0C\u6570\u7EC4\u548C\u5BF9\u8C61\u683C\u5F0F\u7684\u7F29\u8FDB\u4E5F\u4F1A\u540C\u6B65\u4F7F\u7528\u3002",
        tab_size_options: {
          zero: "0 \u4E2A\u7A7A\u683C",
          one: "1 \u4E2A\u7A7A\u683C",
          two: "2 \u4E2A\u7A7A\u683C",
  ...
  var zh_TW_default = {
    ...
    settings: {
      ...
      output: {
        ...
        tab_size: "TAB \u7E2E\u6392\u7A7A\u683C\u6578",
        tab_size_description: "\u6309 TAB \u6642\u63D2\u5165\u7684\u7A7A\u683C\u6578\uFF0C\u6700\u591A 3 \u500B\uFF0C\u9663\u5217\u548C\u7269\u4EF6\u683C\u5F0F\u7684\u7E2E\u6392\u4E5F\u6703\u540C\u6B65\u4F7F\u7528\u3002",
        tab_size_options: {
          zero: "0 \u500B\u7A7A\u683C",
          one: "1 \u500B\u7A7A\u683C",
          two: "2 \u500B\u7A7A\u683C",
  ...
  // src/shared/config/outputConfig.js
  var DEFAULT_OUTPUT_TAB_SIZE = 2;
  var MIN_OUTPUT_TAB_SIZE = 0;
  var MAX_OUTPUT_TAB_SIZE = 3;
  function normalizeOutputTabSize(value) {
...
${result.join(",\n")}
  ...
  var zh_CN_default = {
    ...
    settings: {
      ...
      output: {
        ...
        tab_size: "TAB \\u7F29\\u8FDB\\u7A7A\\u683C\\u6570",
        tab_size_description: "\\u6309 TAB \\u65F6\\u63D2\\u5165\\u7684\\u7A7A\\u683C\\u6570\\uFF0C\\u6700\\u591A 3 \\u4E2A\\uFF0C\\u6570\\u7EC4\\u548C\\u5BF9\\u8C61\\u683C\\u5F0F\\u7684\\u7F29\\u8FDB\\u4E5F\\u4F1A\\u540C\\u6B65\\u4F7F\\u7528\\u3002",
        tab_size_options: {
          zero: "0 \\u4E2A\\u7A7A\\u683C",
          one: "1 \\u4E2A\\u7A7A\\u683C",
          two: "2 \\u4E2A\\u7A7A\\u683C",
  ...
  var zh_TW_default = {
    ...
    settings: {
      ...
      output: {
        ...
        tab_size: "TAB \\u7E2E\\u6392\\u7A7A\\u683C\\u6578",
        tab_size_description: "\\u6309 TAB \\u6642\\u63D2\\u5165\\u7684\\u7A7A\\u683C\\u6578\\uFF0C\\u6700\\u591A 3 \\u500B\\uFF0C\\u9663\\u5217\\u548C\\u7269\\u4EF6\\u683C\\u5F0F\\u7684\\u7E2E\\u6392\\u4E5F\\u6703\\u540C\\u6B65\\u4F7F\\u7528\\u3002",
        tab_size_options: {
          zero: "0 \\u500B\\u7A7A\\u683C",
          one: "1 \\u500B\\u7A7A\\u683C",
          two: "2 \\u500B\\u7A7A\\u683C",
  ...
  function getOutputTabIndent(tabSize2) {
    return " ".repeat(normalizeOutputTabSize(tabSize2));
  }
  // src/shared/utils/text/formatting.js
  var formatTextsForTranslation = (texts, format = "array", options = {}) => {
    const { includeArrayBrackets: includeArrayBrackets2 = true, tabSize: tabSize2 = DEFAULT_OUTPUT_TAB_SIZE } = options;
    const indent = getOutputTabIndent(tabSize2);
    const pairs = Array.isArray(texts) ? texts.map((item) => {
      if (typeof item === "string") {
        return { sourceText: item, translation: "" };
      }
...
\${result.join(",\\n")}
  ...
  var tabSize = DEFAULT_OUTPUT_TAB_SIZE;
...
`], { type: "application/javascript" });
  ...
  var performQuickScan = async () => {
    const { filterRules: filterRules2, enableDebugLogging, outputFormat, includeArrayBrackets, tabSize } = loadSettings();
...
`;
  ...
  var handleTextareaKeyDown = (event) => {
    if (event.key !== "Tab" || event.shiftKey || !outputTextarea || outputTextarea.readOnly) return;
    if (outputTextarea.disabled) return;
    const indent = getOutputTabIndent(loadSettings().tabSize);
    if (indent.length === 0) return;
    event.preventDefault();
    outputTextarea.setRangeText(
      indent,
  ...
  function createMainModal() {
    ...
    outputTextarea.addEventListener("keydown", handleTextareaKeyDown);
...
--- ${warningMessage} ---`;
  ...
  function updateModalAddonsVisibility() {
    ...
    if (outputTextarea) {
      ...
      outputTextarea.style.tabSize = String(normalizeOutputTabSize(settings.tabSize));
    }
  }
...
<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="m380-300 280-180-280-180v360ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z"/></svg>`;
  ...
  // src/shared/ui/components/customSelectAnimation.js
  var CUSTOM_SELECT_OPTIONS_MAX_HEIGHT = 200;
  function getCustomSelectOptionsMaxHeight(contentHeight) {
  ...
  function createToggleSwitch(id, title, description = "", checked = false, tooltipConfig = null) {
    const input = document.createElement("input");
    input.id = id;
    ...
    if (tooltipConfig?.text) {
      ...
      infoIconElement.addEventListener("click", showTooltip2);
      infoIconElement.addEventListener("keydown", showTooltip2);
  ...
  // src/shared/ui/components/infoNotice.js
  function createInfoNotice(iconSVG, text) {
    const container = document.createElement("div");
...
${entries.join("\n")}
  ...
  var bracketsCheckboxElement = null;
  var tabSizeSelectContainer = null;
  var handleBracketsChange = () => {
      ...
      if (selectWrapper) {
        ...
        if (definition.type === "image-card-select") {
          ...
          selectComponents[definition.key] = new CustomSelect(
            selectWrapper,
            options,
            definition.valueType === "number" ? String(currentSettings[definition.key]) : currentSettings[definition.key]
          );
        }
      }
    });
